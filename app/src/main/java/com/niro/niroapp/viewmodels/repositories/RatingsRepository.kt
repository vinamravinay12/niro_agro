...
class RatingsRepository(private val submitRatingsPostData: SubmitRatingsPostData,context: Context?) : Repository(context) {
    ...
    override fun getResponse(): MutableLiveData<APIResponse> {
        ...
        getAPIInterface()?.updateRatings(submitRatingsPostData)?.enqueue(object : Callback<GenericAPIResponse<String>> {
