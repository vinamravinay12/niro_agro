...
class CreateSellOrderRepository(private val createSellOrderPostData: CreateSellOrderPostData,context : Context?) : Repository(context)  {
    ...
    override fun getResponse(): MutableLiveData<APIResponse> {
        ...
        getAPIInterface()?.createSellOrder(createSellOrderPostData)?.enqueue(object:
