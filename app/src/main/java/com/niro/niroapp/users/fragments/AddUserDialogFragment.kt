...
class AddUserDialogFragment : DialogFragment() {
    ...
    private fun launchContactsFragment() {
        mNavigationController.navigate(R.id.action_dialog_select_users_to_navigation_contacts)
        dismiss()
    }

    private fun launchCreateUserManuallyFragment() {
        mNavigationController.navigate(R.id.action_dialog_select_users_to_navigation_create_users_manually)
        dismiss()
    }
}