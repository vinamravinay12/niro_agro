...
class GetPaymentsForContactRepository(private val paymentForContactPostData : GetOrdersForContactPostData,context : Context?) : Repository(context) {
    ...
    override fun getResponse(): MutableLiveData<APIResponse> {
        ...
        getAPIInterface()?.getPaymentsForContact(paymentForContactPostData)?.enqueue(object :
